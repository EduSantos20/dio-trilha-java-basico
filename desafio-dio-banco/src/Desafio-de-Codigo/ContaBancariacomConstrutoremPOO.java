...
class ContaBancaria {
  // Crie uma variável para armazenar o saldo da conta
  private double saldo;
  // Crie o construtor que inicializa a conta com um saldo inicial fornecido
  // pelo usuário:
  ...
  public void sacar(double valor) {
    ...
    if (valor > saldo) {
      // Se for, imprime uma mensagem informando que o saque não pode ser realizado
